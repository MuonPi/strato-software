...
class StratoMqttHandler : public QObject
{
    Q_OBJECT
...
public:
    ...
    StratoMqttHandler(const QString &station_id, const QString &host, unsigned port, const int verbosity = 0);
...
private:
    ...
    [[nodiscard]] auto publish_(const std::string &topic, const std::string &content) -> bool;
    ...
    static constexpr std::size_t first_retry_period{1};
    static constexpr std::size_t max_retry_period{3};
    static constexpr std::size_t s_max_tries{100};
